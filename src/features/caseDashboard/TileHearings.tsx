// src/features/caseDashboard/TileHearings.tsx
...
export const TileHearings = ({ tileId, menuActions }: TileComponentProps) => {
  ...
  if (!tileData) return <div>Error: Hearings data not found.</div>;
